...
class KLogger
{
    ...
    /**
     * Thershold of logging messages that shall be outpued to console.
     * If null then no cnsole output
     * @var integer
     */
    ...
    public static function instance($logDirectory = false, $severity = false)
    {
        ...
        $logDirectory = KLogger::$root_dir . '/' . $logDirectory;
    ...
    public function log($line, $severity)
    {
        ...
        if ($this->consoleOutput && $this->consoleOutput >= $severity) {
            $status = $this->_getTimeLine($severity);
            echo "$status $line \n";
        }
    }
...
KLogger::$root_dir = dirname(__FILE__).'/../../../log';